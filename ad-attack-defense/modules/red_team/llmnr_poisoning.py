"""
Red Team — LLMNR / NBT-NS Poisoning simulation.
Capture des hashes NTLMv2 via Responder lorsque LLMNR est activé sur le réseau.
...
def run_attack(interface: str = "eth0", duration_s: int = 60,
    ...
    if not responder_running:
        ...
        # Parse Responder logs for captured hashes
